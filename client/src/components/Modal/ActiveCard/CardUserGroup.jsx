...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
  ...
  // Lấy activeBoard từ redux ra để lấy dc toàn bộ thông tin của các members thuộc board thông qua field FE_allUsers
  const board = useSelector(selectCurrentActiveBoard);
  /** Thành viên trong card sẽ phải là tập con của thành viên trong board
   * Vì thế dựa vào màng board.FE_allUsers và card.memberIds rồi chúng ta tạo ra một mảng FE_CardMembers chứa đủ thông tin của User đề hiển thị ra ngoài giao diện, bởi mặc định trong card chỉ lưu đám Id của User thôi (memberIds)
   */
